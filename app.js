...
function createNote(title, text) {
  ...
  noteEl.innerHTML = `
    <div class="note-header">
      ...
      <div>
        ...
        <button class="note-favorites"><i class="fa-solid fa-heart"></i></button>
  ...
  const favBtn = noteEl.querySelector('.note-favorites');
  ...
  favBtn.addEventListener('click', (e) => {
    note.switchbackground-color(red)
    
  });
//отлавливаем кнопку избранное
...
addBtn.addEventListener('click', (e) => {
  const el = createNote("Имя ", "Номер телефона");
